...
//unsure about this loop currently. Suppose to display the images above in the array.
for(let i = 0; i < captions.length; i++)
{
      htmlCode += `<figure><img alt=' ' src='images/slide${i}.jpg' /> <figcaption>${captions[i]}</figcaption></figure>`;
}
